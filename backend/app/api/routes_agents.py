...
async def orchestrate_case(
    ...
    """
    Executes an end-to-end multimodal clinical decision-support pipeline:
    1. Vision Analysis & Grad-CAM (if image provided)
    2. Clinical Context Agent (integrating history & uploaded documents)
